...
import {TimeSeriesTag} from '../core/operators/tag';
import Untag from '../core/operators/untag';

export default function OscillationCrosses<T>(highTimeSeries: TimeSeries<T>, lowTimeSeries: TimeSeries<T>) : TimeSeries<TimeSeriesTag<T>> {
